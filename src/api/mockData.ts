  ...
  alerts: [
    {
      ...
      description:
        '3 new recurring charges detected from "Cloud SaaS" in the last 48h.',
      iconColor: "#EF4444",
    },
    {
      id: "a2",
      ...
      description:
        'Your "Rainy Day" fund has reached its target of $20k. Redirecting flows?',
      iconColor: "#F59E0B",
    },
    {
      id: "a3",
      ...
      description:
        "AAPL and MSFT paid dividends today. Automatic reinvestment pending.",
      iconColor: "#3B82F6",
    },
  ],
  spending: [
